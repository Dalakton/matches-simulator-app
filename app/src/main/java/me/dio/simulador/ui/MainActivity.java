...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://dalakton.github.io/matches-simulator-api/")
    ...
    private void setupMatchesList() {
        binding.recycleMatches.setHasFixedSize(true);
        binding.recycleMatches.setLayoutManager(new LinearLayoutManager(this));
        binding.recycleMatches.setAdapter(matchesAdapter);
        findMatchesFromApi();
    }
